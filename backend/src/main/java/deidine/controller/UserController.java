...
import deidine.dto.LoginDto;
import deidine.dto.UserDataDTO;
import deidine.dto.UserResponseDTO;
import deidine.service.UserService;
...
public class UserController {
  ...
  public ResponseEntity<String> signup(@ApiParam("Signup User") @RequestBody UserDataDTO user) {
